...
import seccionDoradaFuncion from "./Methods/seccionDorada";
import seccionDoradaTramosFuncion from "./Methods/doradaPorTramos"

class Aurea extends React.Component{
  constructor(props){
      super(props)
      this.state={
          model:{
  ...
  handleObjective = objective => {
    ...
    resolucionModelo(){
      ...
      respuesta = seccionDoradaFuncion(funcion, extremoA, extremoB, delta,obj)
      }
      //Resolucion por tramos
      else{
        ...
        try {
          respuesta = seccionDoradaTramosFuncion(funciones, delta, obj)
        }
        catch(error){
          ...
          if (respuesta!==false){
              ...
              this.state.salida = respuesta
                ...
                ReactDOM.render(resp, document.getElementById("resultadosDorada"))
  ...
  let botonTipoFuncion = (
    <ButtonGroup>
      ...
      <Col xs={12} md={6} className="my-4 mx-auto ">
                  ...
                  <h2>Metodo de la seccion dorada</h2>
              ...
              <UncontrolledPopover flip={false} trigger="hover" placement="top" target="CardVariables">
                ...
                <PopoverBody>
                  Aquí debes ingresar los elementos necesarios para la resolucion del modelo a traves de la seccion dorada
                </PopoverBody>
              </UncontrolledPopover>
              <br/>
              <Card outline color="secondary" id="CardVariables" className="w-100 mt-3 mx-auto">
                ...
                <InputGroup className="mt-1" id="funcionObj">
                    ...
                    <Input
                      name="funcion"
                      placeholder="Ingrese la funcion: Variable x"
                      
                      onChange={this.handleInput}
                      
                    />
                    <UncontrolledPopover flip={false} trigger="focus hover" placement="auto" target="funcionObj">
                      <PopoverBody>Aquí debes ingresar la funcion objetivo a optimizar. Usar variable x</PopoverBody>
                    </UncontrolledPopover>
                </InputGroup>
