...
//console.log(algebrite.nroots('-(0*(0*x))^2-(0*(-2*x)+1)^2').toString())
...
Z1 = 0;
valorR = 1;
var url = 'https://nlsystemsolver.herokuapp.com/getmsg/?ecuaciones=';
...
while ((math.abs(Z0-Z1) > 0.1) && (valorR > 0.1)){
